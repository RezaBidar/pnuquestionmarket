...
date_default_timezone_set('Europe/Rome');
	...
	//user CI session for authentication
	//copy CI index.php to inside this file and modify system , application app
	//remove function(base_url , is_really_writable , is_php) from include->utils.php cause had confilit with CI
	ob_start();
	require('index.php');
	ob_end_clean();
	$CI =& get_instance();
	$_SESSION['RF']['language'] = 'fa_IR' ;
	$_SESSION['RF']['language_file'] = 'D:\wamp\www\pnu\public_html\filemanager/lang/fa_IR.php' ;

	if( ! $CI->session->userdata('logged_in') ){
		die('RB : You don\'t have permission ... Contact Administrator Please ... ') ;
	}
...
$config = array(
	...
	*/
	...
	'base_url' => 'http://localhost/pnu/public_html',
